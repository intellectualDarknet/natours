...
},{"./login.js":"qZEOz","./updateSettings.js":"28JcJ","./mapbox.js":"cr3Up","./stripe.js":"hu9K2"}],"qZEOz":[function(require,module,exports) {
...
const updateSettings = async (data, type)=>{
    ...
    try {
        ...
        if (res.data.status === "success") {
            (0, _alertsJs.showAlert)("success", `${type.toUpperCase()} updated successfully`);
            location.reload(true);
        }
    } catch (err) {
        // console.log('stack', err.stack)
        (0, _alertsJs.showAlert)("error", err.response);
    }
};

},{"./alerts.js":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"cr3Up":[function(require,module,exports) {
...
const displayMap = (locations)=>{
    ...
    locations.forEach((loc)=>{
        ...
        new mapboxgl.Popup({
            ...
            offset: 30
        }).setLngLat(loc.coordinates)// add html mark 
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}]},["7LaUj","4uyBp"], "4uyBp", "parcelRequire11c7")
